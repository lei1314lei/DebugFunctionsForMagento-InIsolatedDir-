...
define('MARTIN_DEBUG_MAGENTO', MARTIN_DEBUG_ROOT.DS.'Magento');
...
if (defined('COMPILER_INCLUDE_PATH')) {
     ...
     */
    $paths = array();
    $paths[] = MARTIN_DEBUG_MAGENTO. DS . 'app' . DS . 'code' . DS . 'local';
    $paths[] = MARTIN_DEBUG_MAGENTO. DS . 'app' . DS . 'code' . DS . 'community';
    $paths[] = MARTIN_DEBUG_MAGENTO. DS . 'app' . DS . 'code' . DS . 'core';
    $paths[] = MARTIN_DEBUG_MAGENTO. DS . 'lib';
...
final class Mage
{
    ...
    {
        Mage::log(__FILE__."    ".$name,null,\Martindebug\Config::LOG_FILE_EVENTS_NAME);
